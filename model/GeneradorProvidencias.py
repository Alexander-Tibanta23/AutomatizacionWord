    ...
    def create_word_document(treeview, combo, gender_combo):
        ...
        for item in treeview.get_children():
            ...
            if item_values[4] == selected_concept:
                ...
                total_valor_capital_formatted = format(total_valor_capital, ".2f")
                ord_count += 1
...
def save_details(name, ruc, id_number, lawyer, judge, titulo_credito, concepto, valor_capital, valor_liquidacion, detail_treeview):
    ...
    detail_treeview.insert('', 'end', values=(titulo_credito, name, ruc, id_number, concepto, f"{valor_capital:.2f}", f"{valor_liquidacion:.2f}", valor_30, lawyer, judge))
...
treeFrame.grid(row=0, column=1, sticky='nsew', pady=10)
